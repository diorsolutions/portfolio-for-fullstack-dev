...
export const projectsData = [
  ...
  {
    id: 5,
    title: "Cheff Bros E-Commerce",
    description:
      "A premium restaurant ordering and e-commerce platform with real-time state management, seamless animations, and a highly responsive checkout workflow.",
    image: "/mini-restoran.jpg",
    tech: ["Supabase", "Framer Motion", "Radix UI", "React Router", "Vite", "Tailwind CSS"],
    liveUrl: "https://shefhoddog.uz",
    codeUrl: "https://github.com/diorsolutions/cheff-bros-ecommerce",
    featured: true,
  },
  {
    id: 6,
    title: "PIRLS Students Test Platform",
    description:
      "A sophisticated educational assessment system with real-time analytics, secure student authentication, and dynamic test generation.",
    image: "/projects/pirls.png",
    tech: ["Next.js", "Supabase SSR", "Recharts", "Zod", "Tailwind CSS", "Radix UI"],
    liveUrl: "https://studients-test-platform.vercel.app",
    codeUrl: "https://github.com/diorsolutions/studients-test-platform",
    featured: true,
  },
];
